...
% 19. Regla para determinar si una pareja de personas puede procrear
% Una pareja puede procrear si son de sexos opuestos y no
% son parientes cercanos 4
% uso del operador OR, porque aunque no sean pareja de casados pueden
% procrear
